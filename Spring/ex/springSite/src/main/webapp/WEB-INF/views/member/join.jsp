			...
			<form id="memberForm" class="form-horizontal">
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-3">
						...
						name="userId" maxlength="12"
						class="form-control"
						placeholder="User ID" />
					</div>
					<div class="col-sm-2">
						<input type="button" id="idConfirmBtn"
						value="아이디 중복체크"
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-3">
						...
						name="birth" maxlength="6"
						class="form-control" placeholder="주민등록번호 6자리">
					</div>
					<div class="col-sm-2">
						<input type="text" id="gender"
						name="gender" maxlength="1"
						class="form-control" placeholder="주민등록번호 7번째 1자리">
					</div>
					<div class="col-sm-5">
						<p class="form-control-static error">
						</p>
