...
public class LoginVO extends LoginHistory{
	...
	public String toString() {
		return "LoginVO [userId=" + userId + ", userPw=" + userPw + ", userName=" + userName + ", getUserId()="
				+ getUserId() + ", getUserPw()=" + getUserPw() + ", getUserName()=" + getUserName() + ", getIdx()="
				+ getIdx() + ", getRetry()=" + getRetry() + ", getLastFailedLogin()=" + getLastFailedLogin()
