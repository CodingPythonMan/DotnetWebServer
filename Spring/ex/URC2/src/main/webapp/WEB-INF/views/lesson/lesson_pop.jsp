...
<script type="text/javascript">
	$(function(){
		...
		$("#deleteData").click(function(){
			if(confirm("삭제를 진행할까요?")){
				$("#lessonForm").attr("action", "/student/deleteLesson.do");
				$("#lessonForm").submit();
			}
		});
	...
	function validateForm(){
		if($("#l_abbre").val().replace(/\s/g, "") == ""){
			alert("과목코드를 입력해주세요.");
			return false;
		}
		if($("#l_name").val().replace(/\s/g, "") == ""){
			alert("과목명을 입력해주세요.");
			return false;
		}
		return true;
			...
			<table border="1">
				...
				<tbody>
					<tr>
						...
						<td><input type="text" id="l_abbre" name="l_abbre" value="${lessonVO.l_abbre }" /></td>
					</tr>
					<tr>
						<th><span class="required">*</span>과목명</th>
						<td><input type="text" id="l_name" name="l_name" value="${lessonVO.l_name }" /></td>
					</tr>
