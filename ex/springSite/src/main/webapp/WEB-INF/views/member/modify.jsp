		...
		<div class="well">
			<form id="memberForm" class="form-horizontal">
				...
				<div class="form-group form-group-sm">
					<label for="userId"
					class="col-sm-2 control-label">사용자 ID</label>
					<div class="col-sm-3">${member.userId }
					</div>
				</div>
				<div class="form-group form-group-sm">
					<label for="oldUserPw"
					class="col-sm-2 control-label">기존 비밀 번호</label>
					<div class="col-sm-3">
				...
				<div class="form-group form-group-sm">
					<label for="userPw"
					class="col-sm-2 control-label">변경할 비밀번호</label>
					<div class="col-sm-3">
				...
				<div class="form-group form-group-sm">
					...
					class="col-sm-2 control-label">변경할 비밀번호 확인</label>
					<div class="col-sm-3">
						<input type="password" id="userPwCheck"
						name="userPwCheck" maxlength="15"
						class="form-control"
				...
				<div class="form-group form-group-sm">
					<label for="birth"
					class="col-sm-2 control-label">생년월일</label>
					<div class="col-sm-3">
						${member.pinno }******
					</div>
				</div>
				...
				<div class="form-group form-group-sm">
					<label for="emailName"
					class="col-sm-2 control-label">회원 이메일</label>
					<div class="col-sm-3">
					...
					<div class="col-sm-3">
						<p class="form-control-staic error">
						</p>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-6">
						...
						id="modifyCancel" class="btn btn-default" />
					</div>
				</div>
			</form>
		</div>
